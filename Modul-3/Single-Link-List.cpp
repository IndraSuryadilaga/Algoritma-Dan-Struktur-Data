...
void tambahBelakang() {
  ...
  cout<<"Data \""<<dataBaru<<"\" berhasil dimasukan di bagian belaknag."<<endl;
}
    ...
    do {
      if(cari == bantu->data){
        cout<<"Setiap data yang berada di dalam tanda kurung siku([..]) "
            <<"merupakan data yang dicari."<<endl;
        cout<<"Linked List : ";
        bantuTampilkan = head;
...
void hapusData() {
  if(isEmpty() == 0) {
    ...
    if(apaDitemukan == true) {
      ...
      cout<<"Setipa data \""<<cari<<"\" yang terdapat pada Linked List telah dihapus";
...
void sisipkanSetelah() {
  if(isEmpty() == 0) {
    ...
    if(apaAda == true) {
      cout<<"Masukan data yang ditambahkan : ";
      cin>>dataBaru;
      ...
      cout<<"Data \""<<prevData<<"\" tidak ditemukan pada Linked List."<<endl;
    }
  } else cout<<"Tidak terdapat data pada Linked List."<<endl;
}
